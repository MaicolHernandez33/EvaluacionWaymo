...
# waymo_evaluacion documentation build
...
from waymo_evaluacion import __version__ as release

# -- Project information -----------------------------------------------------

project = "waymo_evaluacion"
author = "Kedro"
...
htmlhelp_basename = "waymo_evaluaciondoc"
...
latex_documents = [
    (
        master_doc,
        "waymo_evaluacion.tex",
        "waymo_evaluacion Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "waymo_evaluacion",
        "Project waymo_evaluacion codebase.",
        "Data-Science",
    )
]
